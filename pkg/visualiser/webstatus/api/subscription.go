...
// IncidentUpdate is the resolver for the IncidentUpdate field.
func (r *subscriptionResolver) IncidentUpdate(ctx context.Context, szenario *string) (<-chan *ent.Incident, error) {
