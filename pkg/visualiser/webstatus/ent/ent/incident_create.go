...
func (ic *IncidentCreate) check() error {
	...
	if _, ok := ic.mutation.IncidentID(); !ok {
		return &ValidationError{Name: "IncidentID", err: errors.New(`ent: missing required field "Incident.IncidentID"`)}
	}
...
// SetLevel sets the "Level" field.
func (u *IncidentUpsert) SetLevel(v int) *IncidentUpsert {
	u.Set(incident.FieldLevel, v)
	return u
}

// UpdateLevel sets the "Level" field to the value that was provided on create.
func (u *IncidentUpsert) UpdateLevel() *IncidentUpsert {
	u.SetExcluded(incident.FieldLevel)
	return u
}
...
// SetLevel sets the "Level" field.
func (u *IncidentUpsertOne) SetLevel(v int) *IncidentUpsertOne {
...
// AddLevel adds v to the "Level" field.
func (u *IncidentUpsertOne) AddLevel(v int) *IncidentUpsertOne {
	return u.Update(func(s *IncidentUpsert) {
		s.AddLevel(v)
	})
}
...
// SetLevel sets the "Level" field.
func (u *IncidentUpsertBulk) SetLevel(v int) *IncidentUpsertBulk {
	return u.Update(func(s *IncidentUpsert) {
		s.SetLevel(v)
	})
}
...
// AddLevel adds v to the "Level" field.
func (u *IncidentUpsertBulk) AddLevel(v int) *IncidentUpsertBulk {
	return u.Update(func(s *IncidentUpsert) {
		s.AddLevel(v)
	})
}
