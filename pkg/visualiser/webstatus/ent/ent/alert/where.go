...
func Level(v int) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func LevelEQ(v int) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldLevel), v))
	})
}
...
func LevelNEQ(v int) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func LevelIn(vs ...int) predicate.Alert {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LevelNotIn(vs ...int) predicate.Alert {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LevelGT(v int) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func LevelGTE(v int) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func LevelLT(v int) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func LevelLTE(v int) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
