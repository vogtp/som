...
func (ac *AlertCreate) SetLevel(i int) *AlertCreate {
...
func (ac *AlertCreate) check() error {
	if _, ok := ac.mutation.Level(); !ok {
		return &ValidationError{Name: "Level", err: errors.New(`ent: missing required field "Alert.Level"`)}
	}
...
// SetLevel sets the "Level" field.
func (u *AlertUpsert) SetLevel(v int) *AlertUpsert {
	u.Set(alert.FieldLevel, v)
	return u
}

// UpdateLevel sets the "Level" field to the value that was provided on create.
func (u *AlertUpsert) UpdateLevel() *AlertUpsert {
	u.SetExcluded(alert.FieldLevel)
	return u
}

// AddLevel adds v to the "Level" field.
func (u *AlertUpsert) AddLevel(v int) *AlertUpsert {
	u.Add(alert.FieldLevel, v)
	return u
}
...
// SetLevel sets the "Level" field.
func (u *AlertUpsertOne) SetLevel(v int) *AlertUpsertOne {
...
// AddLevel adds v to the "Level" field.
func (u *AlertUpsertOne) AddLevel(v int) *AlertUpsertOne {
	return u.Update(func(s *AlertUpsert) {
		s.AddLevel(v)
	})
}
...
// UpdateLevel sets the "Level" field to the value that was provided on create.
func (u *AlertUpsertOne) UpdateLevel() *AlertUpsertOne {
	return u.Update(func(s *AlertUpsert) {
		s.UpdateLevel()
	})
}
...
// SetLevel sets the "Level" field.
func (u *AlertUpsertBulk) SetLevel(v int) *AlertUpsertBulk {
	return u.Update(func(s *AlertUpsert) {
		s.SetLevel(v)
	})
}
...
// AddLevel adds v to the "Level" field.
func (u *AlertUpsertBulk) AddLevel(v int) *AlertUpsertBulk {
	return u.Update(func(s *AlertUpsert) {
		s.AddLevel(v)
	})
}
...
// UpdateLevel sets the "Level" field to the value that was provided on create.
func (u *AlertUpsertBulk) UpdateLevel() *AlertUpsertBulk {
	return u.Update(func(s *AlertUpsert) {
		s.UpdateLevel()
	})
}
