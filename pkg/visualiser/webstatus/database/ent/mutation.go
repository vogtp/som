...
// OldIntLevel returns the old "IntLevel" field's value of the Alert entity.
// If the Alert object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AlertMutation) OldIntLevel(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIntLevel is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldIntLevel requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldIntLevel: %w", err)
	}
	return oldValue.IntLevel, nil
}

// AddIntLevel adds i to the "IntLevel" field.
func (m *AlertMutation) AddIntLevel(i int) {
	if m.add_IntLevel != nil {
		*m.add_IntLevel += i
	} else {
		m.add_IntLevel = &i
	}
...
func (m *AlertMutation) Fields() []string {
	...
	if m._IntLevel != nil {
		fields = append(fields, alert.FieldIntLevel)
	}
	if m._Username != nil {
...
// OldIntLevel returns the old "IntLevel" field's value of the Incident entity.
// If the Incident object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
func (m *IncidentMutation) Fields() []string {
	...
	if m._IntLevel != nil {
		fields = append(fields, incident.FieldIntLevel)
	}
	if m._Username != nil {
